        ...
        <table>
                ...
                <tbody>
                        <tr>
                            ...
                            <td>
                                <form method="post" action="/CuoiKy_Coffee_Shop/CartUpdateServlet">
                            ...
                            <td>
                                <form method="post" action="/CuoiKy_Coffee_Shop/CartRemoveServlet">
                                    <input type="hidden" name="id" value="<%= i.getSanpham().getId()%>">
                ...
                <div class="col-lg-6">
                    ...
                    <%@include file = "SQLDataAccess.jsp"%>
                        ...
                        <div class="row align-items-center mb-5">
                            ...
                            <form action="/CuoiKy_Coffee_Shop/AddCart" method="post">
