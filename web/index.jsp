    ...
    <body>
        ...
        <div class="signin-modal">
            <div class="signin-container">
                ...
                <h1>ĐĂNG NHẬP</h1>
                <form action="/Coffee_Shop/login" method = "post" ">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 booking-container">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            ...
                            <form action="/Coffee_Shop/BookingServlet" method="post" class="booking-form">
...
<div class="container-fluid pt-5">
    <div class="container">
        ...
        <div class="comments">
            ...
            <form class="comment-form" action="/Coffee_Shop/CommentServlet" method="post">
