...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="bookingDetail.jsp" class="nav-item nav-link">Booking</a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            ...
            <div class="d-inline-flex mb-lg-5">
                ...
                <p class="m-0 text-white">Menu Manage</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid pt-5">
        <div class="container">
    <form action="/Coffee_Shop/dosanpham" method = "post" enctype="multipart/form-data">
        ...
        <%!SQLDataAccess con = new SQLDataAccess();%>
            <select id ="fLoai" name = "fLoai">
                <%
                    String SQL="Select * from tbLoaiCoffee";
